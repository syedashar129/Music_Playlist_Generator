...
print('Your playlist :')
print(*Playlist)
#bet i think it works
#ya bet i think its good
...
'''
          for i, line in enumerate(RAP):
              if i == rap3 and rap2015:
                   Playlist.add(line)
                   print(str(i+1)+' rap2015 - '+line)
                   break
              if i == rap2 and rap2008:
                   Playlist.add(line)
                   print(str(i+1)+' rap2008 - '+line)
                   break
              if i == rap1 and rap2000:
                   Playlist.add(line)
                   print(str(i+1)+' rap2000 - '+line)
                   break
              if i > 62:
                   break
          '''
